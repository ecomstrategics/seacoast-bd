...
export function CTASection({ variant = "orange", heading = "Ready to talk through your project?", subtext = "Tell us what you are planning or what needs attention, and we will help you understand the next step.", buttonLabel = "Request a Quote" }: { variant?: "orange" | "navy"; heading?: string; subtext?: string; buttonLabel?: string }) {
