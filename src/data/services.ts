...
export const services: Service[] = [
  { slug: "roof-certification-inspection", name: "Roof Certification Inspection", shortDescription: "Insurance-ready roof certification reports with photos, condition notes, and estimated remaining roof life.", icon: "📋", pillar: "protect" },
  ...
  { slug: "exterior-cleaning-services", name: "Exterior Cleaning Services", shortDescription: "Soft washing, pressure washing, roof cleaning, concrete cleaning, gutter cleaning, and solar panel cleaning for homes and businesses.", icon: "💦", pillar: "improve" },
  { slug: "solar-services", name: "Solar Services", shortDescription: "Solar panels, inverters, storage, EV charging, and maintenance through Seacoast's solar team.", icon: "☀️", pillar: "improve" },
  { slug: "solar-panel-cleaning", name: "Solar Panel Cleaning", shortDescription: "Professional solar panel cleaning and maintenance contracts that keep your system producing at peak output across Southwest Florida. One-time cleans and recurring service plans.", icon: "🧼", pillar: "improve" },
  { slug: "whole-house-battery-systems", name: "Whole-House Battery Systems", shortDescription: "Whole-house battery backup installation that keeps your home powered through storms and outages across Southwest Florida. Pairs with solar or works on its own.", icon: "🔋", pillar: "protect" },
